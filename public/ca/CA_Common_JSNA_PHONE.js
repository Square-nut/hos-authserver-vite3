///JSNA的key值为userCertCode-CertNo、证书信息暂为空
var ca_key = (function() {
    
    var Const_Vender_Code = "JSNA";
	...
	function oGetUsrSignatureInfo(key) {
	    ...
	    usrSignatureInfo["CertificateSN"] = oGetCertNo(key);
	...
	function oGetCertInfoByUserCode(userCode, phoneNum) {
	    ...
	    usrSignatureInfo["CertificateSN"] = ret.certSN;    //与certNo一致
	    usrSignatureInfo["uKeyNo"] = "";
	   	usrSignatureInfo["signImage"] = ret.certImage;
