...
var requestAnimFrame = (function() {
  return win.requestAnimationFrame || win.webkitRequestAnimationFrame || win.mozRequestAnimationFrame || function(callback: FrameRequestCallback) { window.setTimeout(callback, 1000 / 60) }
})()
...
function position(): number {
  const parent = document.body.parentNode as HTMLElement | null
  return document.documentElement.scrollTop || (parent?.scrollTop ?? 0) || document.body.scrollTop
}
