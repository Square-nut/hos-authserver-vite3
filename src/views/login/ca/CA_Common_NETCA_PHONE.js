var ca_key = (function() {
	...
	function iPushSignDataQR(inData,key,token) {
		...
		var para = {VenderCode:Const_Vender_Code,SignType:Const_Sign_Type,InData:inData,Key:key,Token:token};
		var rtnStr = window.showModalDialog("../csp/dhc.certauth.pushsign.qrcode.csp",para,"dialogWidth:400px;dialogHeight:500px;toolbar=no;menubar:no;scrollbars:no;resizable:no;location:no;status:no;help:no;fullscreen=no");
